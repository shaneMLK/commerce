...
const Banner: FC<Props> = ({ blok }) => {
  const renderedText = (blok && StoryblokService.client.richTextResolver) ? StoryblokService.client.richTextResolver.render(blok.text) : ''
  return (
          ...
          <div className={cn('swiper-slide-caption section-lg', s.padding)}>
            <div className="container">
              <div className="col-lg-7 col-xl-6 pl-xl-5 pl-xxl-0">
                ...
                <p className="text-decorate fadeGel animated" dangerouslySetInnerHTML={{ __html: renderedText }} ></p>
              </div>
            </div>
          </div>
        </div>
